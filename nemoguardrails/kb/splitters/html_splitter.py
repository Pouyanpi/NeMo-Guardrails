...
class HtmlSplitter(BaseSplitter):
    ...
    Example:
        ...
        >>> chunks = parser.split(html_content)
        >>> for chunk in chunks:
...
The split method now just loops over all the tags in the HTML document and calls _handle_tag for each one. This makes the code more modular and easier to understand.
"""
