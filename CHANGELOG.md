...
- *(runnable)* Complete rewrite of RunnableRails with full LangChain Runnable protocol support ([#1366](https://github.com/NVIDIA-NeMo/Guardrails/issues/1366)) 
- *(runnable-rails)* Implement AIMessage metadata parity in RunnableRails ([#1369](https://github.com/NVIDIA-NeMo/Guardrails/issues/1369)) 
- *(runnable-rails)* Stream metadata in RunnableRails output ([#1370](https://github.com/NVIDIA-NeMo/Guardrails/issues/1370)) 
...
- Add Trend Micro Vision One AI Application Security community integration ([#1355](https://github.com/NVIDIA-NeMo/Guardrails/issues/1355)) 
...
- *(benchmark)* AIPerf run script ([#1501](https://github.com/NVIDIA-NeMo/Guardrails/issues/1501)) 
...
- *(iorails)* Create IORails hierarchy with content-safety support ([#1638](https://github.com/NVIDIA-NeMo/Guardrails/issues/1638)) 
- *(iorails)* Use single engine with correct lifecycle ([#1649](https://github.com/NVIDIA-NeMo/Guardrails/issues/1649)) 
- *(iorails)* Add synchronous generate() method ([#1654](https://github.com/NVIDIA-NeMo/Guardrails/issues/1654)) 
- *(iorails)* Add topic-safety input rail ([#1656](https://github.com/NVIDIA-NeMo/Guardrails/issues/1656)) 
- *(library)* Add regex detection rails ([#1614](https://github.com/NVIDIA-NeMo/Guardrails/issues/1614)) 
- *(iorails)* Add Jailbreak detection rail ([#1658](https://github.com/NVIDIA-NeMo/Guardrails/issues/1658)) 
- *(iorails)* Parallel rails ([#1660](https://github.com/NVIDIA-NeMo/Guardrails/issues/1660)) 
...
- *(iorails)* IORails support for streaming output rails ([#1765](https://github.com/NVIDIA-NeMo/Guardrails/issues/1765)) 
...
- *(iorails)* IORails stream_async() integration into chat and server ([#1766](https://github.com/NVIDIA-NeMo/Guardrails/issues/1766)) 
- *(llm)* Add streaming tool call accumulation and LLMResponse parity ([#1789](https://github.com/NVIDIA-NeMo/Guardrails/issues/1789)) 
- *(iorails)* Telemetry - minimal non-streaming trace ([#1793](https://github.com/NVIDIA-NeMo/Guardrails/issues/1793)) 
- *(iorails)* Telemetry - full non-streaming trace ([#1794](https://github.com/NVIDIA-NeMo/Guardrails/issues/1794)) 
- *(iorails)* Telemetry - streaming trace ([#1798](https://github.com/NVIDIA-NeMo/Guardrails/issues/1798)) 
- *(iorails)* Telemetry - request-level metrics ([#1812](https://github.com/NVIDIA-NeMo/Guardrails/issues/1812)) 
- *(llm)* Add default framework with OpenAI-compatible client ([#1797](https://github.com/NVIDIA-NeMo/Guardrails/issues/1797)) 
- *(iorails)* Support non-streaming reasoning-model responses ([#1842](https://github.com/NVIDIA-NeMo/Guardrails/issues/1842)) 
- *(iorails)* Support streaming model reasoning responses ([#1843](https://github.com/NVIDIA-NeMo/Guardrails/issues/1843)) 
- *(iorails)* Telemetry - token-level metrics ([#1846](https://github.com/NVIDIA-NeMo/Guardrails/issues/1846)) 
...
- *(library)* Add support for huggingface lightweight classifiers  ([#1853](https://github.com/NVIDIA-NeMo/Guardrails/issues/1853)) 
- *(embeddings)* Replace Annoy with exact NumPy search ([#1957](https://github.com/NVIDIA-NeMo/Guardrails/issues/1957)) 
- *(benchmark)* Add Annoy migration benchmarks ([#1958](https://github.com/NVIDIA-NeMo/Guardrails/issues/1958)) 
- *(iorails)* Telemetry - Content capture ([#1972](https://github.com/NVIDIA-NeMo/Guardrails/issues/1972)) 
- *(iorails)* Telemetry - Add usage, request, response attributes to LLM span ([#2009](https://github.com/NVIDIA-NeMo/Guardrails/issues/2009)) 
- *(iorails)* Tool-calling - non-streaming tool calling to main LLM ([#2016](https://github.com/NVIDIA-NeMo/Guardrails/issues/2016)) 
- *(library)* Add context bloat detection rail ([#1941](https://github.com/NVIDIA-NeMo/Guardrails/issues/1941)) 
- *(iorails)* Tool-calling - streaming tools from main LLM ([#2024](https://github.com/NVIDIA-NeMo/Guardrails/issues/2024)) 
- *(server)* Add `/v1/guardrail/checks` endpoint ([#2013](https://github.com/NVIDIA-NeMo/Guardrails/issues/2013)) 
- *(server)* Add tool calling support ([#1942](https://github.com/NVIDIA-NeMo/Guardrails/issues/1942)) 
- *(iorails)* Add tool-calling rails to RailsManager and ModelRegistry ([#2030](https://github.com/NVIDIA-NeMo/Guardrails/issues/2030)) 
- *(iorails)* Connect tool-calling up in IORails ([#2058](https://github.com/NVIDIA-NeMo/Guardrails/issues/2058)) 
- *(examples)* Introduce NIM-based example notebooks, retire superseded ones (NGUARD-724) ([#1906](https://github.com/NVIDIA-NeMo/Guardrails/issues/1906)) 
...
- *(runtime)* Stop execution after internal error ([#1323](https://github.com/NVIDIA-NeMo/Guardrails/issues/1323)) 
- *(streaming)* Handle internal errors in SSE streaming for parallel … ([#1324](https://github.com/NVIDIA-NeMo/Guardrails/issues/1324)) 
...
- *(ci)* Prevent duplicate runs on PR updates ([#1406](https://github.com/NVIDIA-NeMo/Guardrails/issues/1406)) 
- *(runnable-rails)* Preserve message metadata in RunnableRails tool calling ([#1405](https://github.com/NVIDIA-NeMo/Guardrails/issues/1405)) 
- *(community)* Fix import package declaration to new cleanlab-tlm name ([#1401](https://github.com/NVIDIA-NeMo/Guardrails/issues/1401)) 
...
- Ensure that stop token is not ignored if llm_params is None ([#1529](https://github.com/NVIDIA-NeMo/Guardrails/issues/1529)) 
...
- *(iorails)* Fix failing tests due to ModelManager refactor ([#1791](https://github.com/NVIDIA-NeMo/Guardrails/issues/1791)) 
...
- *(iorails)* Add all LLMRails methods to Guardrails facade ([#1886](https://github.com/NVIDIA-NeMo/Guardrails/issues/1886)) 
- *(iorails)* Add LLMRails `llm` and `runtime` getters ([#1889](https://github.com/NVIDIA-NeMo/Guardrails/issues/1889)) 
- *(iorails)* Annotate cancelled OTEL spans with error ([#1897](https://github.com/NVIDIA-NeMo/Guardrails/issues/1897)) 
- *(library)* `detect_regex_pattern()` crashes with TypeError during output streaming ([#1932](https://github.com/NVIDIA-NeMo/Guardrails/issues/1932)) 
- *(library)* `detect_regex_pattern()` matches during output streaming but does not block ([#1937](https://github.com/NVIDIA-NeMo/Guardrails/issues/1937)) 
...
- *(llmrails)* Load library files deterministically (2/5) ([#1975](https://github.com/NVIDIA-NeMo/Guardrails/issues/1975)) 
...
- *(streaming)* Don't reuse stale  across output-rail chunks ([#1935](https://github.com/NVIDIA-NeMo/Guardrails/issues/1935)) ([#1943](https://github.com/NVIDIA-NeMo/Guardrails/issues/1943)) 
- *(ci)* Update README version during releases ([#50](https://github.com/NVIDIA-NeMo/Guardrails/issues/50)) 
...
- Guardrails public API ([#1933](https://github.com/NVIDIA-NeMo/Guardrails/issues/1933)) 
- Refactor validators and fields to support pydantic v2 ([#967](https://github.com/NVIDIA-NeMo/Guardrails/issues/967)) 
...
- Rm old doc page no longer applicable ([#1321](https://github.com/NVIDIA-NeMo/Guardrails/issues/1321)) 
- Release notes for 0.15 and more doc fixes ([#1315](https://github.com/NVIDIA-NeMo/Guardrails/issues/1315)) 
...
- Prepare 0.18 doc release ([#1493](https://github.com/NVIDIA-NeMo/Guardrails/issues/1493)) 
- Add nemotron safety guard ([#1494](https://github.com/NVIDIA-NeMo/Guardrails/issues/1494)) 
- Clean up documentation language and references ([#1514](https://github.com/NVIDIA-NeMo/Guardrails/issues/1514)) 
- *(fix)* Fix appearance of translation ([#1500](https://github.com/NVIDIA-NeMo/Guardrails/issues/1500)) 
- Add release notes for v0.19.0 ([#1525](https://github.com/NVIDIA-NeMo/Guardrails/issues/1525)) 
...
- Edit multilingual content safety doc, fix incorrect info, and version update for 0.20.0 ([#1597](https://github.com/NVIDIA-NeMo/Guardrails/issues/1597)) 
- Frontmatter updates and content type labels to grid cards ([#1602](https://github.com/NVIDIA-NeMo/Guardrails/issues/1602)) 
- Add json output and search extensions ([#1588](https://github.com/NVIDIA-NeMo/Guardrails/issues/1588)) 
- *(llmrails)* Add check_async/check reference page ([#1626](https://github.com/NVIDIA-NeMo/Guardrails/issues/1626)) 
- *(integration)* Add Agent Middleware documentation ([#1627](https://github.com/NVIDIA-NeMo/Guardrails/issues/1627)) 
- Pysdk reference autogeneration ([#1635](https://github.com/NVIDIA-NeMo/Guardrails/issues/1635)) 
- *(yaml-schema)* Fix guardrails config, streaming, and prompt docs ([#1644](https://github.com/NVIDIA-NeMo/Guardrails/issues/1644)) 
- *(embeddings)* Fix links, model names, and search interface ([#1641](https://github.com/NVIDIA-NeMo/Guardrails/issues/1641)) 
- *(overview)* Add prompts.yml and clarify Colang file locations ([#1640](https://github.com/NVIDIA-NeMo/Guardrails/issues/1640)) 
- *(colang)* Update tutorials with current models and fix links ([#1639](https://github.com/NVIDIA-NeMo/Guardrails/issues/1639)) 
- *(guardrails)* Fix typos, model references, and links in guardrail catalog ([#1651](https://github.com/NVIDIA-NeMo/Guardrails/issues/1651)) 
- *(custom-init)* Fix env var handling, embedding kwargs and LLM interface ([#1646](https://github.com/NVIDIA-NeMo/Guardrails/issues/1646)) 
- *(config)* Fix configuration reference for jailbreak, streaming and sample conversation ([#1643](https://github.com/NVIDIA-NeMo/Guardrails/issues/1643)) 
- *(exceptions)* Update exception types and remove tracing ([#1652](https://github.com/NVIDIA-NeMo/Guardrails/issues/1652)) 
- *(actions)* Fix action docs to match codebase ([#1642](https://github.com/NVIDIA-NeMo/Guardrails/issues/1642)) 
- *(config)* Fix NemoGuard naming and expand LLM providers table ([#1647](https://github.com/NVIDIA-NeMo/Guardrails/issues/1647)) 
- Add redirects ([#1668](https://github.com/NVIDIA-NeMo/Guardrails/issues/1668)) 
...
- OTEL Metrics ([#1864](https://github.com/NVIDIA-NeMo/Guardrails/issues/1864)) 
- Speculative Generation ([#1876](https://github.com/NVIDIA-NeMo/Guardrails/issues/1876)) 
- Misc VDR cleanup fixes ([#1884](https://github.com/NVIDIA-NeMo/Guardrails/issues/1884)) 
...
- Clarify NGC_API_KEY requirements for local GLiNER NIM deployment ([#1916](https://github.com/NVIDIA-NeMo/Guardrails/issues/1916)) 
- Expand 0.22 release notes ([#1909](https://github.com/NVIDIA-NeMo/Guardrails/issues/1909)) 
...
- Migration to Fern ([#1973](https://github.com/NVIDIA-NeMo/Guardrails/issues/1973)) 
- Document Fern docs publishing workflow ([#2015](https://github.com/NVIDIA-NeMo/Guardrails/issues/2015)) 
- Fix remaining links after migration and rm temporary local link checker ([#2018](https://github.com/NVIDIA-NeMo/Guardrails/issues/2018)) 
- *(readme)* Fix broken links to Gurdrails website ([#2046](https://github.com/NVIDIA-NeMo/Guardrails/issues/2046)) 
- *(skills)* Add skills ([#2025](https://github.com/NVIDIA-NeMo/Guardrails/issues/2025)) 
- Improve pages referred in the docs template lib ([#2019](https://github.com/NVIDIA-NeMo/Guardrails/issues/2019)) 
...
- Skip test cases in absense of openai api key 
...
- *(recorded)* Add replay harness (1/5) ([#1974](https://github.com/NVIDIA-NeMo/Guardrails/issues/1974)) 
...
- *(recorded)* Add client cassette coverage (3/5) ([#1976](https://github.com/NVIDIA-NeMo/Guardrails/issues/1976)) 
- *(recorded)* Add rails public API coverage (4/5) ([#1977](https://github.com/NVIDIA-NeMo/Guardrails/issues/1977)) 
- *(recorded)* Add rails library coverage (5/5) ([#1978](https://github.com/NVIDIA-NeMo/Guardrails/issues/1978)) 
- Support aiohttp 3.14 in aioresponses mocks ([#2091](https://github.com/NVIDIA-NeMo/Guardrails/issues/2091)) 

### ⚙️ Miscellaneous Tasks

- Prepare for release v0.15.0 ([#1319](https://github.com/NVIDIA-NeMo/Guardrails/issues/1319)) 
- *(docs)* Rename test_csl.py to csl.py ([#1347](https://github.com/NVIDIA-NeMo/Guardrails/issues/1347)) 
- Prepare for release v0.16.0 ([#1362](https://github.com/NVIDIA-NeMo/Guardrails/issues/1362)) 
...
- Prepare for release v0.17.0 ([#1442](https://github.com/NVIDIA-NeMo/Guardrails/issues/1442)) 
...
- Prepare for release v0.18.0 ([#1491](https://github.com/NVIDIA-NeMo/Guardrails/issues/1491)) 
...
- *(changelog)* Exclude CI commits from changelog generation ([#1520](https://github.com/NVIDIA-NeMo/Guardrails/issues/1520)) 
- Prepare for release v0.19.0 ([#1519](https://github.com/NVIDIA-NeMo/Guardrails/issues/1519)) 
...
- Prepare for release v0.20.0 ([#1598](https://github.com/NVIDIA-NeMo/Guardrails/issues/1598)) 
...
- Prepare for release v0.21.0 ([#1723](https://github.com/NVIDIA-NeMo/Guardrails/issues/1723)) 
...
- Bump nemoguardrails to 0.22.0-rc1 ([#1899](https://github.com/NVIDIA-NeMo/Guardrails/issues/1899)) 
- Bump to 0.22.0-rc2 ([#1901](https://github.com/NVIDIA-NeMo/Guardrails/issues/1901)) 
- Include scripts in docker image ([#1902](https://github.com/NVIDIA-NeMo/Guardrails/issues/1902)) 
- Update dependencies for v0.22 ([#1914](https://github.com/NVIDIA-NeMo/Guardrails/issues/1914)) 
- *(telemetry)* Bump schema to 1.7 ([#1910](https://github.com/NVIDIA-NeMo/Guardrails/issues/1910)) 
- Bump to 0.22.0-rc3 ([#1917](https://github.com/NVIDIA-NeMo/Guardrails/issues/1917)) 
- Prepare for release v0.22.0 ([#1913](https://github.com/NVIDIA-NeMo/Guardrails/issues/1913)) 
- Bump to 0.23.0.dev0 ([#1939](https://github.com/NVIDIA-NeMo/Guardrails/issues/1939)) 
